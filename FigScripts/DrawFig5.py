...
def main():
    ...
    ax71=fig.add_axes([0.03,0.67,0.098*11/8.5,0.098])
    ax72=fig.add_axes([0.17,0.67,0.098*11/8.5,0.098])
    ax73=fig.add_axes([0.31,0.67,0.098*11/8.5,0.098])
    ax74=fig.add_axes([0.45,0.67,0.098*11/8.5,0.098])
    ax81=fig.add_axes([0.5775,0.67,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax82=fig.add_axes([0.7600,0.67,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax91=fig.add_axes([0.03,0.53,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax92=fig.add_axes([0.2125,0.53,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax93=fig.add_axes([0.3950,0.53,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax94=fig.add_axes([0.5775,0.53,0.22,np.sqrt(3)/3*0.22*8.5/11])
    ax95=fig.add_axes([0.7600,0.53,0.22,np.sqrt(3)/3*0.22*8.5/11])
    axX1=fig.add_axes([0.05,0.37,0.16,0.08])
    axX2=fig.add_axes([0.24,0.37,0.16,0.08])
    axX3=fig.add_axes([0.43,0.37,0.16,0.08])
    axY1=fig.add_axes([0.05,0.45,0.16,0.04])
    axY2=fig.add_axes([0.24,0.45,0.16,0.04])
    axY3=fig.add_axes([0.43,0.45,0.16,0.04])
    axZ1=fig.add_axes([0.64,0.37,0.12,0.12])
    # axZ2=fig.add_axes([0.77,0.37,0.04,0.12])
    axZ3=fig.add_axes([0.80,0.37,0.18,0.12])
    ...
    ax2.set_xticks([])
    ax2.set_yticks([])
    ax2.set_title('Phase difference matrix $\\bf{D}$')
    ...
    axX1.set_xlabel('Phase error (rad)',labelpad=0.1)
    axX1.set_ylabel('Cumulative fraction',labelpad=0.1)
    axY1.set_ylabel('PDF',labelpad=6)
    axY1.set_title(r'$\it{HD}$', fontsize=8,pad=0.1)
    ...
    axX2.set_xlabel('Phase error (rad)',labelpad=0.1)
    # axX2.set_ylabel('Cumulative fraction',labelpad=0.1)
    axY2.set_ylabel(None)
    axY2.set_title(r'$\it{GC-1}$', fontsize=8,pad=0.1)
    ...
    axX3.set_xlabel('Phase error (rad)',labelpad=0.1)
    # axX3.set_ylabel('Cumulative fraction',labelpad=0.1)
    axY3.set_ylabel(None)
    axY3.set_title(r'$\it{GC-3}$', fontsize=8,pad=0.1)
    ...
    plt.figtext(ax71_pos.x0-0.02,ax71_pos.y1+0.008,'b',fontsize=15)
    plt.figtext(ax81_pos.x0+0.02,ax81_pos.y1+0.008,'c',fontsize=15)
    plt.figtext(ax91_pos.x0-0.02,ax91_pos.y1+0.008,'d',fontsize=15)
    plt.figtext(axY1_pos.x0-0.02,axY1_pos.y1+0.008,'e',fontsize=15)
    plt.figtext(axZ1_pos.x0-0.02,axZ1_pos.y1+0.008,'f',fontsize=15)
